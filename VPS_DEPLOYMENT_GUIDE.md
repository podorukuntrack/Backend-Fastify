...
# Nomor port berbeda antar penyedia; pada Sumopod 6432 = transaction pooler.
...
DATABASE_URL=postgres://USER:PASSWORD@HOST:6432/DB_NAME

# Khusus drizzle-kit dan pg_dump/psql. Wajib session pooler atau direct
# connection (pada Sumopod: 6433) — DDL dan prepared statement gagal lewat
# transaction pooler.
MIGRATION_DATABASE_URL=postgres://USER:PASSWORD@HOST:6433/DB_NAME
